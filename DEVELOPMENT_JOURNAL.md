...
- **Amazon Brand Filter Show All Toggle & Auto-Advance Pagination:** Added a 1-click "Show All Items" toggle button in the search header and zero-results banner to instantly pause brand filtering, and an automated next-page pagination engine with 1.2s countdown, cancel button, and 10-hop safety guard when 0 items match on a page. Verified via automated headless Chrome tests. See [agent-logs/2026-09-05_11-48_amazon-filter-show-all-auto-advance.md](file:///Users/matt/projects/userscript-bundler/agent-logs/2026-09-05_11-48_amazon-filter-show-all-auto-advance.md).
